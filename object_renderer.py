...
class ObjectRenderer:
    def __init__(self, game):
        ...
        self.wall_textures = self.load_game_textures()
    ...
    def load_game_textures(self):
        return {
            ...
            17: self.get_texture('resources/textures/17.png'),
            18: self.get_texture('resources/textures/18.png'),
            19: self.get_texture('resources/textures/19.png'),
            20: self.get_texture('resources/textures/20.png'),
            21: self.get_texture('resources/textures/21.png'),
            22: self.get_texture('resources/textures/22.png'),
            23: self.get_texture('resources/textures/23.png'),
            24: self.get_texture('resources/textures/24.png'),
            25: self.get_texture('resources/textures/25.png'),
        }